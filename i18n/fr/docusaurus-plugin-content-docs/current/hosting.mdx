...
Ce guide couvre les différentes options d'hébergement et de déploiement pour votre application BowPHP. Que vous utilisiez un serveur traditionnel ou des conteneurs, vous trouverez ici les configurations nécessaires.
...
Les logs de BowPHP se trouvent dans `var/logs/` :
