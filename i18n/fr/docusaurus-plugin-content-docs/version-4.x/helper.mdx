...
Les helpers sont des fonctions raccourcis chargées dans l'application qui permettent de faire rapidement certaines actions. Voici la liste des helpers qui existent dans l'application BowPHP. Voici les helpers disponibles dans l'application.
...
Ce helper permet d'avoir accès au containeur de BowPHP.
...
Permet d'avoir accès au configuration de BowPHP.
...
Permet de complie une vue dans BowPHP.
...
Permet de manipuler l'interface de session dans BowPHP.
