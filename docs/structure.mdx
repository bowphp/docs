...
BowPHP suit le modèle **MVC** (Modèle-Vue-Contrôleur), une architecture éprouvée qui sépare clairement les responsabilités de votre application.
