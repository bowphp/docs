...
A social network authentication package for BowPHP. This package uses [`thephpleague/oauth2-client`](https://github.com/thephpleague/oauth2-client) as a wrapper.
