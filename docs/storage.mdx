...
- [Manipulation des fichiers](#manipulation-des-fichiers)
  ...
  - [Vérifier si le paramètre est un fichier](#vérifier-si-le-paramêtre-est-un-fichier)
  - [Vérifier si le paramètre est un dossier](#vérifier-si-le-paramêtre-est-un-dossier)
