...
- [Intégration avec JavaScript](#intégration-avec-javascript)
  - [Exemple avec jQuery](#exemple-avec-jquery)
  - [Exemple avec Axios](#exemple-avec-axios)
- [Gestion des jetons CSRF](#gestion-des-jetons-csrf)
  - [Jetons dans les en-têtes HTTP](#jetons-dans-les-en-têtes-http)
  - [Jetons dans les cookies](#jetons-dans-les-cookies)
