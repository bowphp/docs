...
- [Ajouter un model](#ajouter-un-model)
  - [Nom de Table](#nom-de-table)
  - [Clés primaires](#clés-primaires)
- [Récupérer les données](#récupérer-les-données)
- [Ajout de contraintes supplémentaires](#ajout-de-contraintes-supplémentaires)
- [Récupération d'agrégats](#récupération-dagrégats)
- [Insertion et mise à jour de modèles](#insertion-et-mise-à-jour-de-modèles)
  - [INSERT](#insert)
  - [Insert via CREATE](#insert-via-create)
  - [UPDATE](#update)
- [Suppression de donnée](#suppression-de-donnée)
