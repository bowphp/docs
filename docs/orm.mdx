...
All methods accept two optional parameters to specify the join columns. The default names are inferred from the name of the related table (`users` → `user_id`) and the model's primary key (`id`).
