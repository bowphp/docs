...
Bow Framework implémente 2 moteurs de template et le template par défaut est **[Tintin](./tintin)**.
:::
...
Pour enregistrer vos directives au démarrage de Bow Framework, créez (ou
