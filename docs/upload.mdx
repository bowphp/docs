...
Ici nous pouvons utiliser la méthode `file` qui retourne `null` ou une instance de [`Bow\Http\UploadedFile`](https://bowphp.com/api/master/Bow/Http/UploadedFile.html).
...
Dans cet exemple, la méthode `file` retournera une [`Bow\Support\Collection`](https://bowphp.com/api/master/Bow/Support/Collection.html) qui contiendra pour chaque occurrence une instance de [`Bow\Http\UploadedFile`](https://bowphp.com/api/master/Bow/Http/UploadedFile.html).
