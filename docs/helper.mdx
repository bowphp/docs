...
Les helpers sont des fonctions globales qui simplifient les tâches courantes dans BowPHP. Ces fonctions raccourcies vous permettent d'accéder rapidement aux fonctionnalités du framework sans avoir à instancier des classes ou injecter des dépendances.
...
Accède au conteneur d'injection de dépendances de BowPHP.
