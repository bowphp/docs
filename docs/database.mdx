...
- [Connexion à plusieurs Bases de donnée](#connexion-à-plusieur-base-de-donnée)
- [Utilisation de requête SQL Brute](#utilisation-de-requête-sql-brute)
  - [Execution de requête Select](#execution-de-requête-select)
  - [Sélection conditionnelle](#sélection-conditionnel)
...
- [Database Transactions](#database-transactions)
  - [Utilisation manuelle de la transaction](#utilisation-manuel-des-transaction)
...
Pour exécuter une requête brute de type `SELECT` nous devrez utiliser la méthode `Database::select` ou le helper `select`. On considère notre table `pets` et que nous sommes bien connectés à la base de donnée.
...
Pour exécuter une requête brute de type `INSERT` nous devrez utiliser la méthode `Database::insert` ou le helper `insert`. On considère toujour notre table `pets` et que nous sommes bien connectés à la base de donnée.
...
Pour exécuter une requête brute de type `DELETE` nous devrez utiliser la méthode `Database::delete` ou le helper `db_delete`. On considère toujour notre table `pets` et que nous sommes bien connectés à la base de donnée.
