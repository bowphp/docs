...
- [Connexion à plusieurs Bases de donnée](#connexion-à-plusieurs-bases-de-donnée)
- [Utilisation de requête SQL Brute](#utilisation-de-requête-sql-brute)
  - [Execution de requête Select](#execution-de-requête-select)
  - [Sélection conditionnelle](#sélection-conditionnelle)
...
- [Database Transactions](#database-transactions)
  - [Utilisation manuelle de la transaction](#utilisation-manuelle-de-la-transaction)
