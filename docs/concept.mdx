...
- [Introduction](#introduction)
  - [Le cycle de vie d'une requête expliqué](#le-cycle-de-vie-dune-requête-expliqué)
  - [Le rôle du routeur en détail](#le-rôle-du-routeur-en-détail)
    - [Détection de la route](#détection-de-la-route)
    - [Association au contrôleur](#association-au-contrôleur)
  - [Une architecture modulaire](#une-architecture-modulaire)
    - [Exemple : Le module Database](#exemple--le-module-database)
    - [**Classe `Bow\Database\DatabaseConfiguration::class`**](#classe-bowdatabasedatabaseconfigurationclass)
    - [**Rôle du Kernel**](#rôle-du-kernel)
  - [Visualisation avec un diagramme](#visualisation-avec-un-diagramme)
  - [Résumé des points importants](#résumé-des-points-importants)
- [Merci aux contributeurs](#merci-aux-contributeurs)
