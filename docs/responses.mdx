...
- [Envoyer un JSON](#envoyer-un-json)
  - [Prototype de la méthode `json`](#prototype-de-la-méthode-json)
  - [Exemple d'envoyé de JSON](#exemple-denvoyé-de-json)
- [Envoyer une réponse depuis les vues](#envoyer-une-réponse-depuis-les-vues)
  - [Prototype de la méthode `render`](#prototype-de-la-méthode-render)
  - [Exemple d'envoye de vue](#exemple-denvoye-de-vue)
  - [Télécharger un fichier](#télécharger-un-fichier)
  - [Prototype de la méthode `download`](#prototype-de-la-méthode-download)
  - [Exemple de télécharger](#exemple-de-télécharger)
