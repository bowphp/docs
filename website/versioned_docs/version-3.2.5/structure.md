...
| __components__ | Contient les scripts et fichiers de styles de l'application. Il contient entre autre le dossier `js`, `sass`, `lang` et le dossier `views`. C'est là que vous allez mettre vos fichiers static et ensuite les compiler |
...
- __Contrôleurs__: Dossier dans lequel sera sauvegardé les contrôleurs de l'application.
...
- __Kernel__: Dossier dans lequel sera sauvegardé la configuration du lanceur de l'application.
