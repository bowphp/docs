...
| [config](#config) | Retrieves or sets a configuration value |
| [app_env](#app_env) | Retrieves an environment variable |
| [app_assets](#app_assets) | Generates the URL of an asset |
| [app_abort](#app_abort) | Interrupts execution with an HTTP error |
| [app_abort_if](#app_abort_if) | Interrupts execution if a condition is true |
...
| [response_download](#response_download) | Forces the download of a file |
...
| [get_response_header](#get_response_header) | Retrieves a header from the response |
...
| [old](#old) | Retrieves the old value of a field |
...
| [get_last_insert_id](#get_last_insert_id) | Retrieves the last inserted ID |
| [app_db_select](#app_db_select) | Executes a SELECT query |
| [app_db_select_one](#app_db_select_one) | Retrieves a single record |
...
| [app_db_statement](#app_db_statement) | Executes a raw SQL query |
...
| [pdo](#pdo) | Retrieves the PDO instance |
...
| [csrf_token](#csrf_token) | Retrieves the current CSRF token |
...
| [str_force_in_utf8](#str_force_in_utf8) | Forces the output to UTF-8 |
...
| [client_locale](#client_locale) | Retrieves the client's language |
