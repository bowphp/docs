...
|------|-------------|---------|
| **Command** | Modifies the system state | Create, update, delete |
| **Query** | Reads data without modification | List, display, search |

:::info When should you use CQRS?
CQRS is useful for complex systems where read and write requirements differ. For simple applications, this pattern can add unnecessary complexity.
:::
...
Queries retrieve data without modifying the system state.
...
Use PHP 8 attributes to bind handlers automatically.
