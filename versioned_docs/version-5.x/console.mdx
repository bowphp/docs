...
Seeding lets you populate your database with data:
...
| `schedule:work` | Starts the scheduler in daemon mode (continuous loop) |
...
class SendReportCommand extends AbstractCommand
{
   ...
   * the raw command name as typed by the user.
   */
