...
```php
// hasOne / hasMany : $foreign_key sur la table liée, $local_key sur cette table
$this->hasMany(Post::class, 'author_id', 'id');

// belongsTo : $foreign_key sur cette table, $local_key sur la table liée
$this->belongsTo(User::class, 'author_id', 'id');

// belongsToMany : $primary_key sur cette table, $foreign_key sur la table liée
$this->belongsToMany(Tag::class, 'post_id', 'tag_id');
```
