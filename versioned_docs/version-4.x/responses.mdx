...
- [Envoyer une réponse](#envoyer-une-réponse)
  - [Une chaîne de caractères](#une-chaine-de-caractère)
...
- [Envoyer un JSON](#envoyer-un-json)
  - [Prototype de la méthode `json`](#protototype-de-la-méthode-json)
  - [Exemple d'envoi de JSON](#exemple-denvoye-de-json)
- [Envoyer une réponse depuis les vues](#envoyer-une-réponse-depuis-les-vues)
  - [Prototype de la méthode `render`](#protototype-de-la-méthode-render)
  - [Exemple d'envoi de vue](#exemple-denvoye-de-vue)
  - [Télécharger un fichier](#télécharger-un-fichier)
  - [Prototype de la méthode `download`](#protototype-de-la-méthode-download)
  - [Exemple de téléchargement](#exemple-de-télécharge)
...
La réponse HTTP peut être un `Model` ou une `Collection` de modèle, Bow la convertit directement en `JSON`.
