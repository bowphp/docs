---
id: migration
title: "Migrations dans Bow Framework"
---
...
Les migrations sont un moyen pour versionner votre base de données qui évolue souvent avec les modifications de l'application.
